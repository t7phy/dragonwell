#ifndef BATHelper_BCMTFANALYSISFACILITY__H
#define BATHelper_BCMTFANALYSISFACILITY__H
...
class BCMTFAnalysisFacility
{
	...
	public:
		...
		TTree* PerformEnsembleTest(TTree* tree, int nensembles, const std::vector<int>& details=std::vector<int>()); 
