...
#include <iostream>
#include <math.h>
#include <FeynmanDiagram/default.h>
...
//	private:
		...
		void          insert_prolog_file(ostream &out, char *prefix, char *suffix);
                void          insert_abbrev(ostream &out);
                void          insert_arrow(ostream &out);
                void          insert_ellipse(ostream &out);
                void          insert_fill(ostream &out);
                void          insert_grid(ostream &out);
                void          insert_max(ostream &out);
                void          insert_text(ostream &out);
                void          insert_tilde(ostream &out);
                void          insert_vertex(ostream &out);
