...
extern void text2PS(ostream &out, char *textptr, double fontsize, char *fontname = (char *)"Times-Roman");

extern void text2PS(ostream &out, char *textptr, double horizfract, double vertfract, double fontsize, char *fontname = (char *)"Times-Roman");
