#ifndef HighMassDY_topDDHelper_h
#define HighMassDY_topDDHelper_h
...
class topDDHelper
{
 ...
 virtual topDDHelper* Clone(int i){
   topDDHelper* ptr = new topDDHelper();
   if(Dimension == 1){
