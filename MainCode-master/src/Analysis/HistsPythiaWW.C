...
void HistsPythiaWW::bookHists(int TotalThread)
{
 ...
 Eta_bin = 5;  Eta_left = 0.0;  Eta_right = 5.0;
 double Eta_binning[6] = {0.0, 0.5, 1.0, 1.5, 2.0, 2.5};

 WY_bin = 6;  WY_left = 0.0;  WY_right = 5.0;
 double WY_binning[7] = {0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0};

 LepE_bin = 1; LepE_left = 0.0; LepE_right = 1000.0;
 double LepE_binning[2] = {0.0, 10000.0};
 ...
 BookHist(WrongLepE_AllFlavor, "WrongLepE_AllFlavor", "WrongLepE_AllFlavor", LepE_bin, LepE_binning);
 BookHist(RightLepE_AllFlavor, "RightLepE_AllFlavor", "RightLepE_AllFlavor", LepE_bin, LepE_binning);
 BookHist(TotalLepE_AllFlavor, "TotalLepE_AllFlavor", "TotalLepE_AllFlavor", LepE_bin, LepE_binning);
 ...
 BookHist(WPlusPt, "WPlusPt", "WPlusPt", 20, 0, 100);
 BookHist(WMinusPt, "WMinusPt", "WMinusPt", 20, 0, 100);
 ...
 BookHist(CosThetaPlusDiff, "CosThetaPlusDiff", "CosThetaPlusDiff", 40, -1, 1);
 BookHist(CosThetaMinusDiff, "CosThetaMinusDiff", "CosThetaMinusDiff", 40, -1, 1);

 BookHist(CosThetaPositiveLeptonNu, "CosThetaPositiveLeptonNu", "CosThetaPositiveLeptonNu", 40, -1, 1);
 BookHist(CosThetaNegativeLeptonNu, "CosThetaNegativeLeptonNu", "CosThetaNegativeLeptonNu", 40, -1, 1);

 BookHist(WPlusDecayStatus, "WPlusDecayStatus", "WPlusDecayStatus", 4, 0, 4);
 BookHist(WMinusDecayStatus, "WMinusDecayStatus", "WMinusDecayStatus", 4, 0, 4);

 BookHist(WPlusRapidity_CMS, "WPlusRapidity_CMS", "WPlusRapdity_CMS", 20, -5, 5);
 BookHist(WMinusRapidity_CMS, "WMinusRapidity_CMS", "WMinusRapdity_CMS", 20, -5, 5);


}

void HistsPythiaWW::outputInformation()
{
 ...
 BoostAsymmetryLepE_AllFlavor = (TH1D *)RightLepE_AllFlavor->at(0)->Clone("BoostAsymmetryLepE_AllFlavor");
 BoostAsymmetryLepE_AllFlavor->Reset();
 AFBFunction(RightLepE_AllFlavor->at(0), WrongLepE_AllFlavor->at(0), BoostAsymmetryLepE_AllFlavor);
 ...
 BoostAsymmetryLepE_AllFlavor->Write();
