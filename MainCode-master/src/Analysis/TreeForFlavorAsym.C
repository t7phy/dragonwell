#define TreeForFlavorAsym_cxx
#include "Analysis/TreeForFlavorAsym.h"

using namespace std;

TreeForFlavorAsym::TreeForFlavorAsym()
{
 Init();
}
...
void TreeForFlavorAsym::ConfigFile(int NFilePerJob, int iRound)
{
...
void TreeForFlavorAsym::ConfigFile(int ifile)
{
 OneFilePerJob = true;
 FirstFile = 0;
 EndFile = 1;
...
void TreeForFlavorAsym::InputFile(vector<TString> RootNames)
{
 this->RootNames = RootNames;

}

void TreeForFlavorAsym::SetBranch(int ifile)
{
...
void TreeForFlavorAsym::GetEntry(int ifile, long i)
{
