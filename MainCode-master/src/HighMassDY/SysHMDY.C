...
void SysHMDY::ReadList(TString ElFileName, TString MuFileName)
{
 TString name;
...
void SysHMDY::Initialize(vector<TString> ElRootNames, vector<TString> MuRootNames)
{
...
void SysHMDY::SaveFile(TString FileName)
{
