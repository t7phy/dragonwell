                                                   ...
                                                   double  rscale_factor, double Escale )
{
  ...
  /// igrid convolution
  m_subproc = subproc;
  std::vector<double> xsec = vconvolute( pdf1, pdf2, alphas, _nloops, rscale_factor, rscale_factor, Escale, Escale );
  m_subproc = -1;
...
TH1D* appl::grid::convolute_subproc(int subproc,
    ...
    std::vector<double> dvec = vconvolute_subproc( subproc, pdf1, pdf2, alphas, _nloops, rscale_factor, Escale );
