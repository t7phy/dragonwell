...
//yfu
extern "C" void convolutesubproc_(const int& id, const int& proc, double* data);

extern "C" void convolutesubprocwrap_(const int& id, const int& proc, double* data,
                               void (*pdf)(const double& , const double&, double* ),
                               double (*alphas)(const double& ) );
//yfu
...
//yfu
extern "C" void convoluteppbarsubproc_(const int& id, const int& proc, double* data);

extern "C" void convoluteppbarsubprocwrap_(const int& id, const int& proc, double* data,
                                    void (*pdf)(const double& , const double&, double* ),
                                    double (*alphas)(const double& ) );
//yfu
...
//yfu
extern "C" void fullconvolutesubproc_(const int& id, const int& proc, double* data,
                               const int& nloops,
                               const double& rscale, const double& fscale  );

extern "C" void fullconvolutesubprocwrap_(const int& id, const int& proc, double* data,
                                   void (*pdf)(const double& , const double&, double* ),
                                   double (*alphas)(const double& ),
                                   const int& nloops,
                                   const double& rscale, const double& fscale  );
