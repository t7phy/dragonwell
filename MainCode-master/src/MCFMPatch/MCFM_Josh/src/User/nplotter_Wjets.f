...
c---                1  --> counterterm for real radiation
     ...
     & etaraptwo,pttwo,LeptonPt,NuPt,LeptonY,NuY
      real(dp):: y5,m34,r35
...
C      call bookplot(n,tag,'W rapidity',y34,wt,wt2,-5._dp,5._dp,0.4_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'W ps-rap',eta34,wt,wt2,-5._dp,5._dp,0.4_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'W pt',pt34,wt,wt2,0._dp,100._dp,2.5_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'W pt',pt34,wt,wt2,0._dp,1200._dp,50._dp,'log')
C      n=n+1
C      if(nproc == 11) then
C       call bookplot(n,tag,'y(lep)',y4,wt,wt2,-5._dp,5._dp,0.4_dp,'lin')
C       n=n+1
C       call bookplot(n,tag,'pt(lep)',pt4,wt,wt2,0._dp,200._dp,4._dp,'lin')
C       n=n+1
C      else          
C       call bookplot(n,tag,'y(lep)',y3,wt,wt2,-5._dp,5._dp,0.4_dp,'lin')
C       n=n+1
C       call bookplot(n,tag,'pt(lep)',pt3,wt,wt2,0._dp,200._dp,4._dp,'lin')
C       n=n+1
C      endif
C
C      call bookplot(n,tag,'Jet 1 pt',ptj1,wt,wt2,
C     &              0._dp,1200._dp,50._dp,'log')
C      n=n+1
C      call bookplot(n,tag,'Jet 1 pt log',ptj1,wt,wt2,
C     &              20._dp,430._dp,5._dp,'log')
C      n=n+1
C      call bookplot(n,tag,'Jet 1 pt lin',ptj1,wt,wt2,
C     &              20._dp,430._dp,5._dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'Jet 1 eta',etaj1,wt,wt2,
...
C      n=n+1
C      call bookplot(n,tag,'Jet 2 eta',etaj2,wt,wt2,
C     &              -5._dp,5._dp,0.2_dp,'lin')
C      n=n+1
...
C      n=n+1
C      call bookplot(n,tag,'Jet 3 eta',etaj3,wt,wt2,
C     &              -5._dp,5._dp,0.2_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'(jet 1,jet 2) invariant mass',mjj,wt,wt2,
C     &              0._dp,425._dp,5._dp,'log')
C      n=n+1
C      call bookplot(n,tag,'delr',delr,wt,wt2,
C     &              0.35_dp,4.85_dp,0.15_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'deleta',deleta,wt,wt2,
C     &              0._dp,4._dp,0.4_dp,'lin')
C      n=n+1
C      call bookplot(n,tag,'etastar',etastar,wt,wt2,
C     &              0._dp,3._dp,0.6_dp,'lin')
C      n=n+1
...
C yfu test pT(l) and pT(v) consistency

C      call dohist(nnew, 'LeptonPt', LeptonPt, wt, wt**2,
C     & (/ 32._dp, 32.25_dp, 32.5_dp, 32.75_dp, 33._dp, 33.25_dp,33.5_dp,
C     & 33.75_dp, 34._dp, 34.25_dp, 34.5_dp, 34.75_dp, 35._dp,35.25_dp,
C     & 35.5_dp, 35.75_dp, 36._dp, 36.25_dp, 36.5_dp, 36.75_dp, 37._dp,
C     & 37.25_dp, 37.5_dp, 37.75_dp, 38._dp, 38.25_dp, 38.5_dp, 38.75_dp,
C     & 39._dp, 39.25_dp, 39.5_dp, 39.75_dp, 40._dp, 40.25_dp, 40.5_dp,
C     & 40.75_dp, 41._dp, 41.25_dp, 41.5_dp, 41.75_dp, 42._dp, 42.25_dp,
C     & 42.5_dp, 42.75_dp, 43._dp, 43.25_dp, 43.5_dp, 43.75_dp, 44._dp,
C     & 44.25_dp, 44.5_dp, 44.75_dp, 45._dp, 45.25_dp, 45.5_dp, 45.75_dp,
C     & 46._dp, 46.25_dp, 46.5_dp, 46.75_dp, 47._dp, 47.25_dp, 47.5_dp, 
C     & 47.75_dp,48._dp/) )
C       nnew=nnew+1

C      call dohist(nnew, 'NuPt', NuPt, wt, wt**2,
C     & (/ 32._dp, 32.25_dp, 32.5_dp, 32.75_dp, 33._dp, 33.25_dp,33.5_dp,
C     & 33.75_dp, 34._dp, 34.25_dp, 34.5_dp, 34.75_dp, 35._dp,35.25_dp,
C     & 35.5_dp, 35.75_dp, 36._dp, 36.25_dp, 36.5_dp, 36.75_dp, 37._dp,
C     & 37.25_dp, 37.5_dp, 37.75_dp, 38._dp, 38.25_dp, 38.5_dp, 38.75_dp,
...
C      call dohist(nnew, "LeptonY", LeptonY, wt, wt**2,
C     & (/-5._dp, -4.75_dp, -4.5_dp, -4.25_dp, -4._dp, -3.75_dp, -3.5_dp,
C     & -3.25_dp, -3._dp, -2.75_dp, -2.5_dp, -2.25_dp, -2._dp, -1.75_dp,
C     & -1.5_dp, -1.25_dp, -1._dp, -0.75_dp, -0.5_dp, -0.25_dp, 0._dp,
C     & 0.25_dp, 0.5_dp, 0.75_dp, 1._dp, 1.25_dp, 1.5_dp, 1.75_dp, 2._dp,
C     & 2.25_dp, 2.5_dp, 2.75_dp, 3._dp, 3.25_dp, 3.5_dp, 3.75_dp, 4._dp,
C     & 4.25_dp, 4.5_dp, 4.75_dp, 5._dp/) )
C       nnew=nnew+1

C      call dohist(nnew, "NuY", NuY, wt, wt**2,
C     & (/-5._dp, -4.75_dp, -4.5_dp, -4.25_dp, -4._dp, -3.75_dp, -3.5_dp,
C     & -3.25_dp, -3._dp, -2.75_dp, -2.5_dp, -2.25_dp, -2._dp, -1.75_dp,
C     & -1.5_dp, -1.25_dp, -1._dp, -0.75_dp, -0.5_dp, -0.25_dp, 0._dp,
C     & 0.25_dp, 0.5_dp, 0.75_dp, 1._dp, 1.25_dp, 1.5_dp, 1.75_dp, 2._dp,
