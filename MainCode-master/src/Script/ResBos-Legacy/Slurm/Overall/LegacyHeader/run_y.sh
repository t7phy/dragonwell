...
export LHAPDFSYS=/lustre/AtlUser/yaofu/LHAPDF
export PATH=/lustre/AtlUser/yaofu/LHAPDF/bin/:${PATH}
export LD_LIBRARY_PATH=/lustre/AtlUser/yaofu/LHAPDF/lib/:${LD_LIBRARY_PATH}
cd $WORKDIR/${WHICHPDF}/$ObservableName/$PDFDIR/$ScaleDIR/JOB$n
./main
###############################################
EOF
