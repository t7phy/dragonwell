...
sed -i '1,15d' $WORKDIR/$WHICHPDF/$ObservableName/$PDFDIR/$ScaleDIR/JOB$n/legacy.out
cat $WORKDIR/$WHICHPDF/$ObservableName/$PDFDIR/$ScaleDIR/JOB$n/legacy.out >> $WORKDIR/$WHICHPDF/$ObservableName/$PDFDIR/$ScaleDIR/JOB1/legacy.out
