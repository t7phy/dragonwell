...
sed -i '1,3d' $WORKDIR/$WHICHPDF/$PDFDIR/$ScaleDIR/JOB$n/w_pert.out
cat $WORKDIR/$WHICHPDF/$PDFDIR/$ScaleDIR/JOB$n/w_pert.out >> $WORKDIR/$WHICHPDF/$PDFDIR/$ScaleDIR/JOB1/w_pert.out
