...
if [ ! -d "${WHICHPDF}_ResBos2" ]; then
    mkdir ${WHICHPDF}_ResBos2
fi
...
#move path
cp $WORKDIR/${WHICHPDF}/${PDFDIR}/${ScaleDIR}/JOB1/Grids/ResBos_GridFile_0.out $WORKDIR/${WHICHPDF}_ResBos2/${PDFDIR}_${ScaleDIR}_w${AORDER}${BORDER}${CORDER}.out
