...
cd $WORKDIR/${KinCorrFlag}/${WHICHPDF}/${PDFDIR}/${ScaleDIR}/JOB1/Grids
cat $WORKDIR/../LegacyHeader/${KinCorrFlag}/${MYPDF}_${SCALECHOICE}_pds/${PDFDIR}/${ScaleDIR}/JOB1/legacy.out |head -15 > header.txt
sed -i '1,15d' $WORKDIR/${KinCorrFlag}/${WHICHPDF}/${PDFDIR}/${ScaleDIR}/JOB1/Grids/ResBos_GridFile_0.out
mv ResBos_GridFile_0.out tem.out
cat header.txt >> ResBos_GridFile_0.out
cat tem.out >> ResBos_GridFile_0.out

#ls $WORKDIR/${KinCorrFlag}/${WHICHPDF}/${PDFDIR}/${ScaleDIR}/JOB1/Grids
#ls $WORKDIR/../LegacyHeader/${KinCorrFlag}/${MYPDF}_pds/${PDFDIR}/${ScaleDIR}/JOB1/legacy.out
