...
//////////////////////////////////////////////////////////////////////////
//Dummy functions replacing CERN library routines if MYPAW is not defined
#ifndef MYPAW
extern "C" {
  void hlimit_(), hscale_(), hidopt_(),hbarx_(),hrout_(),hrput_(),hcdir_(),
    hrend_(),hfill_(),hbook1_(),hbookn_(),hfnt_(),hbnt_(),hbname_(),
    hropen_(),hfn_();
}
