...
if options.analysis == "both":
    ...
    doDilep = True
xAH_logger.info("LJConfig: Configuring analysis preselection to {} setting).".format(options.analysis))
...
grls = {
  ...
  #"2022": "GoodRunsLists/data22_13p6TeV/20230207/data22_13p6TeV.periodAllYear_DetStatus-v109-pro28-04_MERGED_PHYS_StandardGRL_All_Good_25ns_ignore_TRIGLAR.xml",
  #"2023": "GoodRunsLists/data23_13p6TeV/20230828/data23_13p6TeV.periodAllYear_DetStatus-v110-pro31-06_MERGED_PHYS_StandardGRL_All_Good_25ns.xml",
...
triggers_singleMuon = ['HLT_mu20_iloose_L1MU15', 'HLT_mu26_ivarmedium', 'HLT_mu50', 'HLT_mu40']
triggers_diElec = ['HLT_2e12_lhloose_L12EM10VH','HLT_2e17_lhvloose_nod0','HLT_2e24_lhvloose_nod0']

# add Run 3 triggers
triggers_singleMuon += ['HLT_mu24_ivarmedium_L1MU14FCH', 'HLT_mu50_L1MU14FCH']
triggers_diElec += ['HLT_2e24_lhvloose_L12EM20VH', 'HLT_2e24_lhvloose_L12eEM24L']
...
electrons_signal_id_wp_selector_tool     = "Tight" # options as above
electrons_signal_id_wp_efficiency_tool   = "Tight" # options: Tight, Medium, LooseBLayer
...
electrons_signal_iso_wp         = "HighPtCaloOnly"
electrons_signal_trigger_iso_wp = "Tight_VarRad"
...
electrons_signal_iso_wp_list    = "HighPtCaloOnly"
