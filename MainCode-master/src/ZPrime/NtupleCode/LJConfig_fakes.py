...
parser.add_argument('--analysis', dest='analysis', default="both", choices=["lj", "ll", "both", "el"])
...
triggers_singleElec_2024 = [
    # 2024
    # 'HLT_e140_lhloose_L1eEM28M',
    'HLT_e120_lhvloose_L1eEM28M',
    'HLT_e100_lhvloose_L1eEM28M',
    'HLT_e80_lhvloose_L1eEM28M',
    'HLT_e60_lhvloose_L1eEM28M',
...
triggers = triggers_singleElec_2022_2023 + triggers_singleElec_2024


electron_trigger_matching_chains = {
  '2022' : ','.join(triggers_singleElec_2022_2023),
  '2023' : ','.join(triggers_singleElec_2022_2023),
  '2024' : ','.join(triggers_singleElec_2024),
}
...
# - HighPtCaloOnly
electrons_baseline_iso_wp       = ""
electrons_signal_iso_wp         = ""
electrons_signal_trigger_iso_wp = ""
...
dielectron_SF_trigRun2   = "DI_E_2015_e12_lhloose_L1EM10VH_2016_e17_lhvloose_nod0_2017_2018_e24_lhvloose_nod0_L1EM20VH"
dielectron_SF_trigRun3_dict = {
    '2022': '2022_e24_lhvloose',
    '2023': '2023_e24_lhvloose_L1eEM24L',
    '2024': '2023_e24_lhvloose_L1eEM24L', #TODO: update when reco is available
}

# dielectron_SF_trig = dielectron_trigRun3_dict[period] if is_run3 else dielectron_trigRun2
...
c.algorithm("ElectronSelector", {
    ...
    # trigger
    "m_singleElTrigChains"        : electron_trigger_matching_chains[period],
    "m_useRun3navigation"         : doRun3TriggerNav,
...
c.algorithm("ElectronEfficiencyCorrector", {
    "m_name"                      : "ElectronEfficiencyCorrector_Weight5",
    # "m_msgLevel"                  : "DEBUG",
    "m_inContainerName"           : "Electrons_PreSelected",
    "m_WorkingPointReco"          : "",
    "m_WorkingPointPID"           : "Tight",
...
c.algorithm("LJAlgo", {
    ...
    "m_leadLepPtSkim"             : -1 if do_skim else -1.0,
    # "m_mLepJetSkim"               : 700.0 if do_skim else -1.0,
    "m_mLepLepSkim"               : 130.0 if do_skim else -1.0,

    # which skimming to use
    "m_writeEleChannel"           : True, # use this flag to have events with electrons
    "m_writeMuonChannel"          : False, # use this flag to have events with muons
    "m_writeDiLepton"             : doDilep, # use this flag to have dilepton events in your tree
    "m_writeSingleElectron"       : doSingleEl, # use this flag to have dilepton events in your tree
    "m_writeLeptonJet"            : doLepJet, # use this flag to have lepton+jet events in your tree

    # what to save from each object
    "m_evtDetailStr"              : "pileup beamspotweight",
    "m_evtDetailStrSyst"          : "pileup pileupsys beamspotweight",
    ...
    "m_writeTruthJetBranches"     : False, # use this flag to write out the vector truth_jet_* branches
    "m_writeBaseLeptons"          : False, # use this flag if you want to have baseline leptons in the LepPlusJet part of the tree

    "m_useTaus"                   : options.useTaus,

    # triggers
    "m_doTrigMatch"               : False, #false means all leps are trig matched;
